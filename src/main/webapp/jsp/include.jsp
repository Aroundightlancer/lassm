...
<!-- DataTables -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/plugins/datatables/dataTables.bootstrap4.min.css">
...
<!-- DataTables -->
<script src="${pageContext.request.contextPath}/jsp/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="${pageContext.request.contextPath}/jsp/plugins/datatables/dataTables.bootstrap4.min.js"></script>
<!-- SlimScroll -->
<script src="${pageContext.request.contextPath}/jsp/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="${pageContext.request.contextPath}/jsp/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="${pageContext.request.contextPath}/jsp/dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="${pageContext.request.contextPath}/jsp/dist/js/demo.js"></script>
